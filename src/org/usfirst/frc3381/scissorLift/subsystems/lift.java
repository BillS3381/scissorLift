...
being an IED. This will probably be used for example code. */
/**
 * NOTICE (2 Feb 2018)! This code is NOT to be used for PID purposes. Anything involving that 
 * shall be diverted to Extendo. It's basically the same code on there. */
...
public class lift extends Subsystem {
    ...
    private final Encoder encoder1 = RobotMap.liftencoder1;
